...
def main():
    ...
    traindata = pd.read_csv('C:/Users/sound/Desktop/Kaggle/Leaf Classfication/Leaf Classfication Random forest Benchmark/data/train.csv')#read csv file into dataframe
    ...
    testdata = pd.read_csv('C:/Users/sound/Desktop/Kaggle/Leaf Classfication/Leaf Classfication Random forest Benchmark/data/test.csv')
